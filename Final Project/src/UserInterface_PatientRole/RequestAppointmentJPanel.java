...
public class RequestAppointmentJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        requestApptJButton.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        ...
        timeJComboBox.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        ...
        maleJRadioButton.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
    ...
    private void requestApptJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestApptJButtonActionPerformed
        ...
        if (checkBlankInput())
     {
        AppointmentVisitPDCLRequest req = new AppointmentVisitPDCLRequest();
