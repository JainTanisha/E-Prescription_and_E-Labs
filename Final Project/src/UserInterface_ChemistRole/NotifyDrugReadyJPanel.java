 ...
 */
package UserInterface_ChemistRole;
...
public class NotifyDrugReadyJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        requestDrugJButton.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
    ...
    private void requestDrugJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestDrugJButtonActionPerformed
        ...
        AppointmentVisitPDCLRequest appt = (AppointmentVisitPDCLRequest)patientMedicinesJTable.getValueAt(selectedRow, 0);
        appt.setMessage("Yes");
        ...
        Session session = Session.getDefaultInstance(props,
            new javax.mail.Authenticator() {
                protected PasswordAuthentication getPasswordAuthentication(){
                    return new PasswordAuthentication("aedproject15@gmail.com","project15");
                }
            }
        ...
        try{
            ...
            message.setFrom(new InternetAddress("aedproject15@gmail.com"));
